...
app.registerExtension({
  name: "Rikan.PromptRelay.Timeline", // <-- UBAH JADI UNIK
  ...
  async beforeRegisterNodeDef(nodeType, nodeData) {
    ...
    nodeType.prototype.onNodeCreated = function () {
      ...
      // UBAH NAMA WIDGET DOM AGAR UNIK
      this._timelineWidget = this.addDOMWidget("rikan_prompt_relay_timeline", "RikanPromptRelayTimeline", container, {
        serialize: false,
        hideOnZoom: false,
        getMinHeight: () => 220,
        getHeight: () => 220,
